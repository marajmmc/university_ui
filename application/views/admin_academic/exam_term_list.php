        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
                    <thead>
                        <tr role="row">
                            <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 120px;">Term ID</th>
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 341px;">Term</th>
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 341px;">Time Span</th>
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                        <tr class="odd">
                            ...
                            <td class=" ">First Mid Term</td>
                            <td class=" ">15/04/2014 - 21/04/2014</td>
                            <td class=" ">Active</td>
                        </tr>
                        <tr class="odd">
                            <td class=" sorting_1">002</td>
                            <td class=" ">Second Mid Term</td>
                            <td class=" ">08/08/2014 - 15/08/2014</td>
                            <td class=" ">Active</td>
                        </tr>
                        <tr class="odd">
                            <td class=" sorting_1">003</td>
                            <td class=" ">Semester Final</td>
                            <td class=" ">08/11/2014 - 20/11/2014</td>
                            <td class=" ">Active</td>
                        </tr>
                    </tbody>
                </table>
