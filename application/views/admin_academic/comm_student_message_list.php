                ...
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 241px;">Sending Date</th>
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 241px;">View Detail</th>
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                        <tr class="odd">
                            ...
                            <td class=" ">
                                <div class="col-lg-3">
                                    <a id="" class="btn btn-danger" href="#">View</a>
                                </div>
                            </td>
                        </tr>
                        <tr class="odd">
