...
<!--                            <select class="form-control" name="gender" id="gender" data-original-title="Status" data-placement="top">
                    ...
                    <div class="form-group">
                        <label for="pass1" class="control-label col-lg-4">Designation</label>
                        <div class="col-lg-8">
                            <select class="form-control" id="designation" name="designation" data-original-title="Status" data-placement="top">
                                <option>--Select--</option>
                                <option value="DG-00001">Chairman</option>
                                <option value="DG-00002">Administrator</option>
                                <option value="DG-00003">Director</option>
                                <option value="DG-00004">Principal</option>
                                <option value="DG-00005">Faculty In-charge</option>
                                <option value="DG-00029">Senior Lecturer</option>
                                <option value="DG-00029">Assistant Lecturer</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="dp1" class="control-label col-lg-4">Joining Date</label>
                        <div class="col-lg-8">
                            <input type="text" data-date-format="mm/dd/yy" id="dp2" name="joining_date" placeholder="Joining Date" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="dp1" class="control-label col-lg-4">Teacher Photo</label>
                        <div class="col-lg-8">
