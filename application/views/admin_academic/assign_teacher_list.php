        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
                    <thead>
                        <tr role="row">
                            <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 80px;"> Teacher ID</th>
                            ...
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 147px;">Course Name</th>
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                        <tr class="odd">
                            ...
                            <td class=" ">Database Design & Development</td>
                            <td class=" ">Active</td>
                        </tr>
                        <tr class="odd">
