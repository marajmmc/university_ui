        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
                    <thead>
                        <tr role="row">
                            <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 80px;">Semester ID</th>
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 341px;">Semester Name</th>
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 147px;">Duration</th>
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                        <tr class="odd">
                            ...
                            <td class=" ">Summer</td>
                            <td class=" ">January - April</td>
                            <td class=" ">Active</td>
                        </tr>
                        <tr class="odd">
                            <td class=" sorting_1">02</td>
                            <td class=" ">Fall</td>
                            <td class=" ">May - August</td>
                            <td class=" ">Active</td>
                        </tr>
                        <tr class="odd">
                            <td class=" sorting_1">03</td>
                            <td class=" ">Spring</td>
                            <td class=" ">September - December</td>
                            <td class=" ">Active</td>
                        </tr>
                    </tbody>
                </table>
