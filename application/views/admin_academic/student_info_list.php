                ...
                <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 204px;">View</th>
                        </tr>
                    </thead>
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                        <tr class="odd">
                            ...
                            <td class=" ">
                                <img src="<?php echo base_url()?>/assets/img/profile_photo_student.jpg" width="10%" />
                                Kamrul Hasan</td>
                            <td class=" ">CSE</td>
                            ...
                            <td class=" ">Active</td>
                            <td class=""><a href="<?php echo base_url() ?>admin/student_profile_info/view" style="background-color: #fff; border: none;">View</a></td>
                        </tr>
                        <tr class="odd">
                            <td class=" sorting_1">14050202</td>
                            <td class=" ">
                                <img src="<?php echo base_url()?>/assets/img/profile_photo_student1.jpg" width="10%" />
                                Md. Maraj Hossain</td>
                            <td class=" ">CSE</td>
                        ...
                        <tr class="odd">
                            ...
                            <td class=" ">
                                <img src="<?php echo base_url()?>/assets/img/profile_photo_student2.jpg" width="10%" />
                                Mostafizur Rahman</td>
                            <td class=" ">EEE</td>
                        ...
                        <tr class="odd">
                            ...
                            <td class=" ">
                                <img src="<?php echo base_url()?>/assets/img/profile_photo_student3.jpg" width="10%" />
                                Mohammad Yasir</td>
                            <td class=" ">Civil</td>
                        ...
                        <tr class="odd">
                            <td class=" sorting_1">14050204</td>
                            <td class=" ">
                                <img src="<?php echo base_url()?>/assets/img/profile_photo_student4.jpg" width="10%" />
                                Susmita Akter</td>
